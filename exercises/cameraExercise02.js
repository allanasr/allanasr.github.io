...
function keyboardUpdate() {
  ...
  if (keyboard.pressed("left")) cameraHolder.rotateY(THREE.MathUtils.degToRad(-1.0));
  if (keyboard.pressed("right")) cameraHolder.rotateY(THREE.MathUtils.degToRad(1.0));
  if (keyboard.pressed("up")) cameraHolder.rotateX(THREE.MathUtils.degToRad(-1.0));
  if (keyboard.pressed("down")) cameraHolder.rotateX(THREE.MathUtils.degToRad(1.0));
  if (keyboard.pressed("Q")) cameraHolder.rotateZ(THREE.MathUtils.degToRad(-1.0));
  if (keyboard.pressed("E")) cameraHolder.rotateZ(THREE.MathUtils.degToRad(1.0));
